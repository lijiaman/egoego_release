...
def prep_smpl_to_qpos_expert(smpl_output_folder, ori_amass_root_folder):
    ...
    smpl_output_filename = os.path.join(smpl_output_folder, "ares_kinpoly_motion.p")
...
def split_scenes(ori_data_file, dest_data_folder, template_meta_file):
    TRAIN_DATASETS = ['CMU', 'MPI_Limits', 'TotalCapture', 'Eyes_Japan_Dataset', 'KIT', 'BioMotionLab_NTroje', 'BMLmovi', 
                    'EKUT', 'ACCAD'] # HuMoR training dataset
    TEST_DATASETS = ['Transitions_mocap', 'HumanEva'] # HuMoR test datasets
    VAL_DATASETS = ['MPI_HDM05', 'SFU', 'MPI_mosh'] # HuMoR validation datasets
...
if __name__ == "__main__":
    ...
    smpl_output_folder = "data/ares_processed_for_kinpoly"
    ...
    ori_data_file = os.path.join(smpl_output_folder, "ares_kinpoly_motion.p")
    ...
    split_scenes(ori_data_file, dest_data_folder, template_meta_file) 
