...
def prep_smpl_to_qpos_expert(smpl_output_folder, ori_amass_root_folder):
    ...
    smpl_seq_data = {} 
    # smpl_output_folder = "/move/u/jiamanli/datasets/gimo_processed/gimo_motion_for_kinpoly"
    ...
    # ori_amass_root_folder = "/move/u/jiamanli/datasets/gimo_processed/smplx_npz_processed"
...
def reorganize_data(ori_data_file, dest_data_folder, template_meta_file):
...
if __name__ == "__main__":
    smpl_output_folder = "data/gimo_processed_for_kinpoly"
    ori_amass_root_folder = "data/gimo/smplx_npz_processed"
    prep_smpl_to_qpos_expert(smpl_output_folder, ori_amass_root_folder)

    # Convert the data to the same organized folder as original kinpoly data 
    ori_data_file = os.path.join(smpl_output_folder, "gimo_kinpoly_motion.p")
