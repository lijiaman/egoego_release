...
if __name__ == "__main__":
    ...
    sr_res_path = f"/viscam/u/jiamanli/results/kinpoly/all/statear/{args.cfg}/results/iter_{args.iter:04d}_test_mocap_annotations.p"
        ...
        if k in all_data:
            if use_humor_res:
                ...
                if debug:
                    ...
                    compute_metrics(new_sr_res, args.algo)
        else:
