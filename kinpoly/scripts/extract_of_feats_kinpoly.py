...
if __name__ == "__main__":
    ...
    data_folder = "/viscam/u/jiamanli/datasets/kin-poly/ReliveDatasetRelease/fpv_raft_of"
    seq_files = os.listdir(data_folder) 
    # Generate feature for trainin dataset 
    with torch.no_grad():
       
        for take in seq_files:
            seq_folder = os.path.join(data_folder, take)
