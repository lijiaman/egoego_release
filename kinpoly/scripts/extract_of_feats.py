...
if __name__ == "__main__":
    ...
    data_folder = "/viscam/u/jiamanli/datasets/egomotion_syn_dataset/habitat_rendering_replica_all"
        ...
        for scene_name in scene_names:
            if ".log" not in scene_name and "script" not in scene_name:
                ...
                for take in seq_files:
                    seq_folder = os.path.join(scene_folder, take, "raft_flows")
                    ...
                    tmp_folder_path = seq_folder.replace("raft_flows", "raft_of_feats")
                    ...
                    for block_idx in range(num_blocks):
                        ...
                        if len(curr_of_files) > 0:
                            ...
                            for t_idx in range(num_steps):
                                ...
                                dest_of_feats_path = of_path.replace("raft_flows", "raft_of_feats")
