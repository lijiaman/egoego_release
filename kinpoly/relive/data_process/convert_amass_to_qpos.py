...
def prep_smpl_to_qpos_expert():
    ...
    smpl_output_folder = "/viscam/u/jiamanli/datasets/amass_processed_all_locomotion_for_kinpoly"
...
if __name__ == "__main__":
    ...
    ori_data_file = "/viscam/u/jiamanli/datasets/amass_processed_for_kinpoly/amass_kinpoly_motion.p"
    dest_data_folder = "/viscam/u/jiamanli/datasets/amass_processed_for_kinpoly/MoCapData"
    # reorganize_data(ori_data_file, dest_data_folder)

    ori_data_file = "/viscam/u/jiamanli/datasets/amass_processed_locomotion_for_kinpoly/amass_kinpoly_motion.p"
    dest_data_folder = "/viscam/u/jiamanli/datasets/amass_processed_locomotion_for_kinpoly/MoCapData"
    # reorganize_data(ori_data_file, dest_data_folder)

    ori_data_file = "/viscam/u/jiamanli/datasets/amass_processed_all_locomotion_for_kinpoly/amass_kinpoly_motion.p"
    dest_data_folder = "/viscam/u/jiamanli/datasets/amass_processed_all_locomotion_for_kinpoly/MoCapData"
    reorganize_data(ori_data_file, dest_data_folder)
    # Total number of sequences:605
    # Total number of frames:100907

'''
delta_head = np.repeat(np.array([[0, 0.2, 0.2]]), head_pose.shape[0], axis = 0)
