...
def gen_res_for_infer(data_p_path, slam_res_folder, dest_data_p_path):
    ...
    for seq_name in data:  
        npz_name = seq_name.split("-")[1] + ".npy"
        
        slam_res_path = os.path.join(slam_res_folder, npz_name)
        ...
        if os.path.exists(slam_res_path):
            ...
            for k in ori_data:
                if k == "head_pose":
                    # if curr_slam_head_pose.shape[0] != ori_data['head_pose'].shape[0]:
                    #     import pdb 
                    #     pdb.set_trace() 
...
if __name__ == "__main__":
    # data_p_path = "/viscam/u/jiamanli/datasets/kin-poly/MoCapData/features/mocap_annotations.p"
    # ori_meta_path = "/viscam/u/jiamanli/datasets/kin-poly/MoCapData/meta/mocap_meta.yml"
    data_p_path = "/viscam/u/jiamanli/datasets/kinpoly_processed_for_kinpoly_new/MoCapData/features/mocap_annotations.p"
    ori_meta_path = "/viscam/u/jiamanli/datasets/kinpoly_processed_for_kinpoly_new/MoCapData/meta/mocap_meta.yml"
    ...
    # slam_res_folder = "/viscam/u/jiamanli/datasets/kin-poly/OriData/kinpoly_combined_headformer_and_scale_slam_res_for_s2"
    # slam_res_folder = "/viscam/u/jiamanli/datasets/kin-poly/OriData/droid_slam_res_blocks_max_150"

    slam_res_folder = "/viscam/u/jiamanli/datasets/kin-poly/OriData/seq_50_kinpoly_combined_headformer_and_scale_slam_res_for_s2"
    # slam_res_folder = "/viscam/u/jiamanli/datasets/kin-poly/OriData/seq_50_kinpoly_final_slam_res_for_s2"
    ...
    # dest_data_folder = "/viscam/u/jiamanli/datasets/kin-poly/seq_50_final_combined_all_kinpoly_slam_res_test/MoCapData/features"
    # dest_data_folder = "/viscam/u/jiamanli/datasets/kin-poly/seq_50_final_slam_all_kinpoly_res_test/MoCapData/features"
    
    dest_data_folder = "/viscam/u/jiamanli/datasets/kin-poly/humor_processed_seq_50_final_combined_all_kinpoly_slam_res_test/MoCapData/features"
    # dest_data_folder = "/viscam/u/jiamanli/datasets/kin-poly/humor_processed_seq_50_final_slam_all_kinpoly_res_test/MoCapData/features"
