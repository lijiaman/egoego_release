...
def de_heading(q):
    # tmp_mat = quaternion_matrix(get_heading_q(quaternion_multiply(quaternion_inverse(get_heading_q(q)), q)))
    # print("quat matrix after de_heading:{0}".format(tmp_mat)) 
    # tmp_mat: identity matrix 
