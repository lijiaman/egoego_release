...
from copycat.utils.transform_utils import convert_orth_6d_to_aa
from copycat.smpllib.smpl_mujoco import smpl_to_qpose
...
class DatasetSMPLObj():
    def __init__(self, data_specs, mode = "all", data_mode = "train"):
        ...
        self.netural_path =  "kinpoly/sample_data/standing_neutral.pkl"
